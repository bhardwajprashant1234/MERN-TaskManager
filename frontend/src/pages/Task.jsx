...
const Task = () => {
  ...
  {mode === "add" ? <strong><em><u>Add a New Task</u></em></strong> : "Edit Your Task"}
              ...
              <button className='bg-green text-black px-4 py-2 font-medium hover:from-green-500 hover:to-green-900 hover:bg-gradient-to-r' onClick={handleSubmit}>{mode === "add" ? "Add task" : "Update Task"}</button>

              <button className='ml-4 red-500 text-black px-4 py-2 font-medium hover:from-red-500 hover:to-red-500 hover:bg-gradient-to-r' onClick={() => navigate("/")}>Cancel</button>
